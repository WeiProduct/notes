...
const I18N = {
  en: {
    ...
    deviceLabel2: 'Meeting', deviceCardT2: 'Beta feedback sync', deviceCardP2: 'Decisions and follow-ups, captured.',
    deviceLabel3: 'Reading', deviceCardT3: 'Habit loops, ch. 3', deviceCardP3: 'Environment beats willpower.',
  ...
  'zh-CN': {
    ...
    deviceLabel2: '会议', deviceCardT2: 'Beta 反馈同步', deviceCardP2: '今天电话会的决策与后续跟进。',
    deviceLabel3: '阅读', deviceCardT3: '习惯循环 · 第三章', deviceCardP3: '环境设计胜过意志力。',
